...
<template>
  <div>
    <v-btn :loading="loading" @click="getQrcode()"
      :disabled="props.instance.status === 'open'" class="tw-bg-lime-400" size="small">
    ...
    <v-dialog v-model="dialog" max-width="400">
      <template v-slot:default="{ isActive }">
        <v-card rounded="lg">
          ...
          <v-card-text v-else class="tw-pt-1 tw-flex tw-items-center tw-justify-center">
